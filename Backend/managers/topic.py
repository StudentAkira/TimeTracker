...
class TopicManager:
    ...
    def get_user_topics_with_title_starts_with(self, user_db, title, offset, limit):
    ...
    def get_user_topics_not_related_to_subject(self, user_db: User, subject_db: Subject, offset: int, limit: int)\
            -> list[TopicSchema]:
